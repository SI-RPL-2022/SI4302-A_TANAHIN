...
@section('konten')
    <div class="container">
        <h3 align="center" style="color:#616161" class="mt-5 fw-bolder">Edit Procedure</h3> <br>
        <hr>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('procedure.update',$procedure->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group">
                                    <label for="title">Title</label>
                                    <input type="text" class="form-control" id="title" name="title"
                                        value="{{ $procedure->title }}" placeholder="Title" required>
                                </div>
                                <div class="form-group">
                                    ...
                                    <textarea name="editor1" placeholder="type indonesian description here..." id="summernote"
                                        ...
                                        required>{!! htmlspecialchars_decode(htmlspecialchars($procedure->description)) !!}</textarea>
                                </div>
                                <div class="form-group">
