...
<div class="container">
    <h3  class="mt-5"><a style="color:grey;text-decoration:none;" href="/admin/produk">Produk</a> <b style="color:green">/Tambah Produk</b></h3> <br>
    <hr>
...
<section>
        <div class="container shadow p-3 mt-3 mb-5 bg-white rounded">
            ...
            <div class="form-group">
                ...
                <input type="text" name="kode" class="form-control form-control-lg" id="kode" placeholder="">
            </div>
            <div class="form-group">
                <label for="user_id"><b>ID Pemilik</b></label>
                <input type="number" name="user_id" class="form-control form-control-lg" id="user_id" placeholder="">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                    <input type="checkbox" name="cocok[]" value="Bisnis" id="cocok">
                    <label class="form-label">Bisnis</label>
                    <input type="checkbox" name="cocok[]" value="Pribadi" id="cocok">
                    <label class="form-label">Pribadi</label>
                    <input type="checkbox" name="cocok[]" value="Pabrik" id="cocok">
                    <label class="form-label">Pabrik</label>
                </div>
            </div>
            <div class="form-group">
                <label for="deskripsi"><b>Deskripsi</b></label>
                <textarea name="deskripsi" class="form-control form-control-lg" id="deskripsi"></textarea>
            </div>
